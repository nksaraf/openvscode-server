...
interface IBoundLocalizeFunc {
	(idx: number, defaultValue: null): any;
}
...
function internalLocalize(env: Environment, data: any, message: string, ...args: (string | number | boolean | undefined | null)[]) {
...
// 		this._env = env;
// 		this.localize = (data, message, ...args: (string | number | boolean | undefined | null)[]) => internalLocalize(this._env, data, message, ...args);
// 	}
...
export const localize = (data: any, message: any, ...args: (string | number | boolean | undefined | null)[]) =>
	internalLocalize(env, data, message, ...args);
